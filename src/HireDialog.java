 ...
 *
 */
class HireDialog extends JDialog
		...
		hire.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				else
				{
					...
					else if (resChoice == "Hollywood" && TapiocaKing.money <= 300)
					{
						JOptionPane.showMessageDialog(hireDialog,
					...
					else if ((resChoice == "Jungle" || resChoice == "Coffee" 
						|| resChoice == "Lychee Coconut") && TapiocaKing.money <= 400)
					{
						JOptionPane.showMessageDialog(hireDialog,
					...
					else if ((resChoice == "Green Tea" || resChoice == "Black Tea" || resChoice == "Rose Tea") 
					...
					else if ((resChoice == "Passion Fruit" || resChoice == "Aloe") && TapiocaKing.money <= 80)
					{
						JOptionPane.showMessageDialog(hireDialog,
		                        "You must have over 80 dollars in funds to hire this team",
		                        "Hiring Error",
					...
					else if ((resChoice == "Jelly" || resChoice == "Strawberry") && TapiocaKing.money <= 150)
					{
						JOptionPane.showMessageDialog(hireDialog,
					...
					else if ((resChoice == "Apple" || resChoice == "Lemon") && TapiocaKing.money <= 100)
					{
						JOptionPane.showMessageDialog(hireDialog,
					...
					else if ((resChoice == "Mango") && TapiocaKing.money <= 200)
					{
						JOptionPane.showMessageDialog(hireDialog,
		                        "You must have over 200 dollars in funds to hire this team",
		                        "Hiring Error",
					...
					double sub = Double.parseDouble((String)costfield.getText());
